...
function searchCity(cityname) {
  ...
  $.ajax({
    ...
    .catch((err) => {
      document.getElementById("alertModal").className =
        "modal fixed inline-block rounded-lg overflow-hidden shadow-xl w-full h-full top-0 left-0 flex items-center justify-center";
      $("#closeBtn").on("click", function (err) {
        document.getElementById("alertModal").className =
